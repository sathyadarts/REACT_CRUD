...
function Update() {
    ...
    useEffect(()=>{
        Axios.get("http://localhost:3500/read/"+id).then((response)=>{
    ...
    const updateList=(e)=>{
        e.preventDefault()
        Axios.put("http://localhost:3500/update/"+id,newList)
        .then((res)=>{
            ...
            empList.map((val,key)=>{
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                       ...
                       <select className="form-control" defaultValue={val.gender}
                        onChange={(e)=>{setNewlist({...newList,ngender:e.target.value})}}>
